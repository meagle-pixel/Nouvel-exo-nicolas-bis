...
- **Affichage dynamique** : Extraction et affichage des informations sur les planètes via un fichier JSON.
- **Tri des planètes** : Système de filtrage dynamique des corps célestes par critères.
- **Formulaire interactif** : Formulaire avec gestion des événements et validation en JavaScript.
- **Planétarium interactif** : Interface visuelle dédiée à l'exploration spatiale.
- **Design Responsive** : Grille adaptative pour une consultation optimale sur desktop et mobile.
